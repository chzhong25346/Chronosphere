...
def analysis_hub(type, sdic=None, s=None, ticker=None, backtrace=None, ohlcv=None, weekly_only=False):
    if type == 'turnover':
        ...
        divergence_analysis(sdic, ticker=ticker, backtrace=backtrace, ohlcv=ohlcv, weekly_only=weekly_only)
